...
replace github.com/hashicorp/terraform-plugin-go => github.com/hashicorp/terraform-plugin-go v0.27.0

replace github.com/hashicorp/terraform-plugin-framework => github.com/hashicorp/terraform-plugin-framework v1.15.0

replace github.com/hashicorp/terraform-plugin-framework-validators => github.com/hashicorp/terraform-plugin-framework-validators v0.17.0

require (
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.111.0
	github.com/redpanda-data/terraform-provider-redpanda v1.1.0
)
...
require (
	...
	buf.build/gen/go/redpandadata/cloud/grpc/go v1.5.1-20250320090119-84779f9e5085.2 // indirect
	...
	buf.build/gen/go/redpandadata/dataplane/grpc/go v1.5.1-20250323160046-ca27d7563686.2 // indirect
	buf.build/gen/go/redpandadata/dataplane/protocolbuffers/go v1.36.6-20250707151314-5a9a0d6ac711.1 // indirect
	...
	github.com/hashicorp/hil b69bd425aa3e // indirect
