...
const (
	...
	mainPkg = "redpanda"
	// modules:
	mainMod = "index" // the redpanda module
)

//go:embed cmd/pulumi-resource-redpanda/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov.MustComputeTokens(tokens.SingleModule("redpanda_", mainMod,
