...
namespace Pulumi.Redpanda
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/videmsky/pulumi-redpanda/releases/";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Redpanda.version.txt");
    ...
    internal sealed class RedpandaResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public RedpandaResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
